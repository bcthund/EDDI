...
namespace EddiDataDefinitions
{
    public class OrganicSpecies : ResourceBasedLocalizedEDName<OrganicSpecies>
    {
        ...
        // Terrestrial Species
        public static readonly OrganicSpecies AleoidaArcus = new OrganicSpecies( "AleoidaArcus", OrganicGenus.Aleoids, 7252500, (decimal?)0.30, 175, 180, "", "CarbonDioxide", "None", "B;A;F;K;M;L:T;TTS;Y;N" );
        public static readonly OrganicSpecies AleoidaCoronamus = new OrganicSpecies( "AleoidaCoronamus", OrganicGenus.Aleoids, 6284600, (decimal?)0.30, 180, 190, "", "CarbonDioxide", "None", "B;A;F;K;M;L:T;TTS;Y;N" );
        public static readonly OrganicSpecies AleoidaGravis = new OrganicSpecies( "AleoidaGravis", OrganicGenus.Aleoids, 12934900, (decimal?)0.30, 190, 195, "", "CarbonDioxide", "None", "B;A;F;K;M;L:T;TTS;Y;N" );
        public static readonly OrganicSpecies AleoidaLaminiae = new OrganicSpecies( "AleoidaLaminiae", OrganicGenus.Aleoids, 3385200, (decimal?)0.30, null, null, "", "Ammonia", "", "B;A;F;K;M;L:T;TTS;Y;N" );
        public static readonly OrganicSpecies AleoidaSpica = new OrganicSpecies( "AleoidaSpica", OrganicGenus.Aleoids, 3385200, (decimal?)0.30, null, null, "", "Ammonia", "", "B;A;F;K;M;L:T;TTS;Y;N" );
        ...
        public static readonly OrganicSpecies BlatteumBioluminescentAnemone = new OrganicSpecies( "BlatteumBioluminescentAnemone", OrganicGenus.Sphere, 1499900,null, (decimal?)210, null, "MetalRichBody;HighMetalContentBody","Argon;CarbonDioxide;CarbonDioxideRich;HotSilicateVapour;None","","B" );
        public static readonly OrganicSpecies CroceumAnemone = new OrganicSpecies( "CroceumAnemone", OrganicGenus.Sphere, 1499900,(decimal?)0.42, (decimal?)200, (decimal?)440, "RockyBody","Water;SulphurDioxide;None","","B;A" );
        public static readonly OrganicSpecies LuteolumAnemone = new OrganicSpecies( "LuteolumAnemone", OrganicGenus.Sphere, 1499900,(decimal?)1.32, (decimal?)200, (decimal?)440, "RockyBody","CarbonDioxide;Water;SulphurDioxide;None","","B" );
        public static readonly OrganicSpecies PrasinumBioluminescentAnemone = new OrganicSpecies( "PrasinumBioluminescentAnemone", OrganicGenus.Sphere, 1499900,null, (decimal?)20, null, "RockyBody;MetalRichBody;HighMetalContentBody","CarbonDioxide;Argon;Ammonia;Nitrogen;SulphurDioxide;NeonRich;HotSulphurDioxide;None","","O" );
        public static readonly OrganicSpecies PuniceumAnemone = new OrganicSpecies( "PuniceumAnemone", OrganicGenus.Sphere, 1499900,(decimal?)2.61, (decimal?)65, (decimal?)860, "IceBody","Oxygen;Nitrogen;None","","O;W" );
        public static readonly OrganicSpecies RoseumAnemone = new OrganicSpecies( "RoseumAnemone", OrganicGenus.Sphere, 1499900,(decimal?)0.45, (decimal?)200, (decimal?)440, "RockyBody","SulphurDioxide;None","","B" );
        public static readonly OrganicSpecies RoseumBioluminescentAnemone = new OrganicSpecies( "RoseumBioluminescentAnemone", OrganicGenus.Sphere, 1499900,null, (decimal?)190, null, "MetalRichBody;HighMetalContentBody","CarbonDioxide;SulphurDioxide;None","","B" );
        public static readonly OrganicSpecies RubeumBioluminescentAnemone = new OrganicSpecies( "RubeumBioluminescentAnemone", OrganicGenus.Sphere, 1499900,null, (decimal?)160, null, "MetalRichBody;HighMetalContentBody","Argon;CarbonDioxide;SulphurDioxide;None","","B" );
        ...
        public static readonly OrganicSpecies BarkMounds = new OrganicSpecies( "BarkMounds", OrganicGenus.Cone, 1471900,null, (decimal?)88, (decimal?)440, "RockyBody;HighMetalContentBody;RockyIceBody;IcyBody","None;CarbonDioxide;CarbonDioxideRich;ArgonRich;SulphurDioxide;ThickArgonRich","","" );
        public static readonly OrganicSpecies AureumBrainTree = new OrganicSpecies( "AureumBrainTree", OrganicGenus.Brancae, 1593700,null, (decimal?)300, (decimal?)500, "MetalRichBody;HighMetalContentBody","None;SulphurDioxide","Any","" );
        public static readonly OrganicSpecies GypseeumBrainTree = new OrganicSpecies( "GypseeumBrainTree", OrganicGenus.Brancae, 1593700,(decimal?)0.42, (decimal?)170, (decimal?)330, "RockyBody","Ammonia;None;Oxygen;SulphurDioxide","Any","" );
        public static readonly OrganicSpecies LindigoticumBrainTree = new OrganicSpecies( "LindigoticumBrainTree", OrganicGenus.Brancae, 1593700,null, (decimal?)300, (decimal?)500, "RockyBody;HighMetalContentBody","None","Any","" );
        public static readonly OrganicSpecies LividumBrainTree = new OrganicSpecies( "LividumBrainTree", OrganicGenus.Brancae, 1593700,(decimal?)0.48, (decimal?)300, (decimal?)500, "RockyBody","None;Water;SulphurDioxide","Any","" );
        public static readonly OrganicSpecies OstrinumBrainTree = new OrganicSpecies( "OstrinumBrainTree", OrganicGenus.Brancae, 1593700,null, (decimal?)20, null, "MetalRichBody;HighMetalContentBody","None;CarbonDioxide;Ammonia;CarbonDioxideRich;ArgonRich;SulphurDioxide;Helium;NeonRich","Any","" );
        public static readonly OrganicSpecies PuniceumBrainTree = new OrganicSpecies( "PuniceumBrainTree", OrganicGenus.Brancae, 1593700,null, (decimal?)20, null, "MetalRichBody;HighMetalContentBody","None;CarbonDioxide;Oxygen;SulphurDioxide;Helium;NeonRich","Any","" );
        ...
        public static readonly OrganicSpecies VirideBrainTree = new OrganicSpecies( "VirideBrainTree", OrganicGenus.Brancae, 1593700,(decimal?)0.4, (decimal?)100, (decimal?)255, "RockyIceBody","Ammonia;None;SulphurDioxide","Any","" );
        public static readonly OrganicSpecies CactoidaCortexum = new OrganicSpecies( "CactoidaCortexum", OrganicGenus.Cactoid, 3667600,(decimal?)0.27, (decimal?)158, (decimal?)196, "RockyBody;HighMetalContentBody","CarbonDioxide","None","F;G;A;L;K;N;B;M;H" );
        public static readonly OrganicSpecies CactoidaLapis = new OrganicSpecies( "CactoidaLapis", OrganicGenus.Cactoid, 2483600,(decimal?)0.28, (decimal?)160, (decimal?)225, "RockyBody;HighMetalContentBody","Ammonia","","F;G;H;A;K;N;B;A" );
        public static readonly OrganicSpecies CactoidaPeperatis = new OrganicSpecies( "CactoidaPeperatis", OrganicGenus.Cactoid, 2483600,(decimal?)0.28, (decimal?)160, (decimal?)186, "RockyBody;HighMetalContentBody","Ammonia","","F;G;A;K;N;B;H" );
        public static readonly OrganicSpecies CactoidaPullulanta = new OrganicSpecies( "CactoidaPullulanta", OrganicGenus.Cactoid, 3667600,(decimal?)0.27, (decimal?)127, (decimal?)195, "RockyBody;HighMetalContentBody","CarbonDioxide","None","F;G;H;A;K;N;B" );
        public static readonly OrganicSpecies CactoidaVermis = new OrganicSpecies( "CactoidaVermis", OrganicGenus.Cactoid, 16202800,(decimal?)0.28, (decimal?)160, (decimal?)450, "RockyBody;HighMetalContentBody","Water;SulphurDioxide","","F;G;H;A;M;N;B;K" );
        ...
        public static readonly OrganicSpecies AlbidumSinuousTubers = new OrganicSpecies( "AlbidumSinuousTubers", OrganicGenus.Tubers, 1514500,null, (decimal?)200, (decimal?)500, "RockyBody;HighMetalContentBody","None","Any","" );
        public static readonly OrganicSpecies BlatteumSinuousTubers = new OrganicSpecies( "BlatteumSinuousTubers", OrganicGenus.Tubers, 1514500,null, (decimal?)200, (decimal?)500, "RockyBody;HighMetalContentBody","SulphurDioxide;None","Any","" );
        public static readonly OrganicSpecies CaeruleumSinuousTubers = new OrganicSpecies( "CaeruleumSinuousTubers", OrganicGenus.Tubers, 1514500,null, (decimal?)200, (decimal?)500, "RockyBody;HighMetalContentBody","SulphurDioxide;None","Any","" );
        public static readonly OrganicSpecies LindigoticumSinuousTubers = new OrganicSpecies( "LindigoticumSinuousTubers", OrganicGenus.Tubers, 1514500,null, (decimal?)200, (decimal?)500, "RockyBody;HighMetalContentBody","None","Any","" );
        public static readonly OrganicSpecies PrasinumSinuousTubers = new OrganicSpecies( "PrasinumSinuousTubers", OrganicGenus.Tubers, 1514500,null, (decimal?)200, (decimal?)500, "RockyBody;HighMetalContentBody;RockyIceBody","CarbonDioxideRich;None;CarbonDioxide;SulphurDioxide","Any","" );
        public static readonly OrganicSpecies RoseumSinuousTubers = new OrganicSpecies( "RoseumSinuousTubers", OrganicGenus.Tubers, 1514500,null, (decimal?)200, (decimal?)500, "RockyBody;HighMetalContentBody","CarbonDioxide;CarbonDioxideRich;ArgonRich;SulphurDioxide;None","Any","" );
        public static readonly OrganicSpecies ViolaceumSinuousTubers = new OrganicSpecies( "ViolaceumSinuousTubers", OrganicGenus.Tubers, 1514500,null, (decimal?)200, (decimal?)500, "RockyBody;HighMetalContentBody","None","Any","" );
        public static readonly OrganicSpecies VirideSinuousTubers = new OrganicSpecies( "VirideSinuousTubers", OrganicGenus.Tubers, 1514500,null, (decimal?)200, (decimal?)500, "RockyBody;HighMetalContentBody","SulphurDioxide;None","Any","" );
        ...
        public static readonly OrganicSpecies TubusCavas = new OrganicSpecies( "TubusCavas", OrganicGenus.Tubus, 11873200,(decimal?)0.16, (decimal?)160, (decimal?)200, "RockyBody","CarbonDioxide","None","F;G;H;A;K;N;M;B" );
        public static readonly OrganicSpecies TubusCompagibus = new OrganicSpecies( "TubusCompagibus", OrganicGenus.Tubus, 7774700,(decimal?)0.19, (decimal?)150, (decimal?)190, "RockyBody","CarbonDioxide","None","S;A;K;M;N;M;DC;H;K" );
        public static readonly OrganicSpecies TubusConifer = new OrganicSpecies( "TubusConifer", OrganicGenus.Tubus, 2415500,(decimal?)0.17, (decimal?)160, (decimal?)200, "RockyBody","CarbonDioxide","None","F;G;A;K;N;M;H" );
        public static readonly OrganicSpecies TubusRosarium = new OrganicSpecies( "TubusRosarium", OrganicGenus.Tubus, 2637500,(decimal?)0.16, (decimal?)160, (decimal?)180, "RockyBody","Ammonia","","F;G;A;K;N;B;K" );
        public static readonly OrganicSpecies TubusSororibus = new OrganicSpecies( "TubusSororibus", OrganicGenus.Tubus, 5727600,(decimal?)0.16, (decimal?)160, (decimal?)200, "HighMetalContentBody","Ammonia;CarbonDioxide","None","F;G;A;L;K;N;M;M;DC" );
