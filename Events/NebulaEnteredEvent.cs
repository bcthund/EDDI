...
{
    [PublicAPI]
    public class NebulaEnteredEvent : Event
    {
        public const string NAME = "Nebula Entered";
        public const string DESCRIPTION = "Triggered when you have entered the radius of the nearest Nebula.";
        ...
        [PublicAPI("The distance to the center of the Nebula.")]
        ...
        public NebulaEnteredEvent (DateTime timestamp, Nebula nebula) : base(timestamp, NAME)
        {
            this.nebula = nebula;
        }
    }
